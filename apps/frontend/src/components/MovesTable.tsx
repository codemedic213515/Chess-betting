...
const MovesTable = () => {
  ...
  return (
    <div className=" text-center ">
      {movesArray.length ? <h1 className="mb-10 text-lg">Moves List</h1> : <h1 className=" mt-40"></h1>}
      <div
        className="text-sm h-[45vh] max-h-[45vh] overflow-y-auto scrollbar  scrollbar-thumb-[#b7722d]"
        ref={movesTableRef}
      >
      ...
      {moves.length ? (
        <div className="w-full p-2 bg-[#20211d] flex items-center justify-between">
          ...
          <div className="flex bg-re gap-1">
            <button
              onClick={() => {
