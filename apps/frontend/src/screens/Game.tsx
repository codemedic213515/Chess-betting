...
import { UserAvatarP2 } from '../components/UserAvatarP2';
import buttonImg from '../assets/icons/button.svg';
import boardBg from '../assets/icons/board.png';
      ...
      <div className="justify-center flex">
        <div className="pt-2 w-full">
          <div className="flex gap-8 h-full w-full">
              ...
              <div className="flex justify-center">
                <div>
                  ...
                  <div
                    ...
                    style={{ backgroundImage: `url(${boardBg})`, height: 836, width: 800 }}
                  >
                  ...
                  {started && (
                    <div className="mt-4 flex justify-between">
                      <UserAvatarP2 gameMetadata={gameMetadata} self />
            ...
            <div className="  border-[0.2px] border-[#684018] border-r-[#68401800] justify-between flex-col overflow-auto h-full w-full  ">
              {!started ? (
